...
export const DEFAULT_ERROR_MESSAGES: Record<AppErrorCode, string> = {
  ...
  MISSING_CLAUDE_API_KEY: "서버에 Anthropic API key가 설정되어 있지 않습니다.",
